...
const Hero = () => {
    return (
        <div className="relative h-[50vh] md:h-[70vh] flex items-center justify-center bg-cover bg-center px-6 md:px-12" style={{ backgroundImage: "url('/hamed-taha-YmBgW57IPtk-unsplash.jpg')" }}>
            {/* Overlay */}
